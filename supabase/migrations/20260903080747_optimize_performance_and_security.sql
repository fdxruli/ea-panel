...
ALTER FUNCTION public.update_customer_referral_count(uuid, integer) SET search_path = public;
...
ALTER FUNCTION public.record_discount_usage_and_deactivate(uuid, uuid) SET search_path = public;
ALTER FUNCTION public.return_stock_on_cancellation() SET search_path = public;
ALTER FUNCTION public.get_product_stats_single(uuid) SET search_path = public;
