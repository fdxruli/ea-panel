                    ...
                    {addresses.map(addr => (
                      <div key={addr.id} className={styles.addressItem}>
                        ...
                        {addr.latitude && addr.longitude && (
                          <div className={styles.addressMapContainer}> {/* Añade un estilo para el contenedor del mapa si es necesario */}
                            <ClientOnly>
                              <DynamicMapPicker
                                initialPosition={{ lat: addr.latitude, lng: addr.longitude }}
                                isDraggable={false} // Para que no se pueda mover el pin en esta vista
                              />
                            </ClientOnly>
                          </div>
                        )}
