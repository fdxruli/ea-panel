...
// --- Componente para la gráfica de estado de pedidos ---
...
// --- Componente para la gráfica de productos más vendidos ---
...
export default function Dashboard() {
    ...
    useEffect(() => {
        const fetchStats = async () => {
            ...
            // Obtenemos todos los pedidos y clientes en paralelo
            const { data: ordersData, error: ordersError } = await supabase.from('orders').select('status, total_amount, created_at, customers (name)');
