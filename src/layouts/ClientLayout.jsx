// src/layouts/ClientLayout.jsx (CON NUEVO ENLACE Y CHECKOUT MODAL)

import React from "react";
import { Outlet, Link, NavLink } from "react-router-dom";
import { useCart } from "../context/CartContext";
import { useProducts } from "../context/ProductContext";
import { useCustomer } from "../context/CustomerContext"; // Importa el contexto de cliente
import Cart from "../pages/Cart";
import PhoneModal from "../components/PhoneModal";
import CheckoutModal from "../components/CheckoutModal"; // Importa el modal de checkout
...
export default function ClientLayout() {
  ...
  // --- 👇 LÍNEA MODIFICADA ---
  const { isCheckoutModalOpen, setCheckoutModalOpen, phone, checkoutMode } = useCustomer();
    ...
    <div className="client-layout">
      ...
      <header className="client-header">
        ...
        <nav className="desktop-nav">
            ...
            <NavLink to="/mi-actividad" className="desktop-nav-link"><HeartIcon /><span>Mi Actividad</span></NavLink>
      ...
      {/* --- 👇 RENDERIZADO DEL MODAL CORREGIDO --- */}
      {isCheckoutModalOpen && (
        <CheckoutModal
          phone={phone}
      ...
      <footer className="bottom-nav">
        ...
        <NavLink to="/mi-actividad" className="bottom-nav-link"><HeartIcon /><span>Mi Actividad</span></NavLink>
