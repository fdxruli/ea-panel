...
tables = {
    'admin_role': "CREATE TYPE public.admin_role AS ENUM ('admin', 'staff');",
    'discount_type': "CREATE TYPE public.discount_type AS ENUM ('global', 'category', 'product');",
    'order_status': "CREATE TYPE public.order_status AS ENUM ('pendiente', 'en_proceso', 'completado', 'cancelado', 'en_envio');",
    
    'referral_levels': """CREATE TABLE public.referral_levels (
  ...
  CONSTRAINT referral_levels_pkey PRIMARY KEY (id)
    ...
    'rewards': """CREATE TABLE public.rewards (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  level_id uuid,
  ...
  CONSTRAINT products_category_id_fkey FOREIGN KEY (category_id) REFERENCES public.categories(id)
    ...
    'product_images': """CREATE TABLE public.product_images (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  ...
  CONSTRAINT product_images_product_id_fkey FOREIGN KEY (product_id) REFERENCES public.products(id)
    ...
    'ingredients': """CREATE TABLE public.ingredients (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  name character varying NOT NULL,
  ...
  CONSTRAINT ingredients_pkey PRIMARY KEY (id)
    ...
    'ingredient_purchase_units': """CREATE TABLE public.ingredient_purchase_units (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  ...
  CONSTRAINT ingredient_purchase_units_ingredient_id_fkey FOREIGN KEY (ingredient_id) REFERENCES public.ingredients(id)
    ...
    'ingredient_purchases': """CREATE TABLE public.ingredient_purchases (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  ingredient_id uuid NOT NULL,
  ...
  CONSTRAINT ingredient_purchases_purchase_unit_id_fkey FOREIGN KEY (purchase_unit_id) REFERENCES public.ingredient_purchase_units(id)
    ...
    'product_recipes': """CREATE TABLE public.product_recipes (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  product_id uuid NOT NULL,
  ingredient_id uuid NOT NULL,
  ...
  CONSTRAINT customers_referrer_id_fkey FOREIGN KEY (referrer_id) REFERENCES public.customers(id)
    ...
    'customer_addresses': """CREATE TABLE public.customer_addresses (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  ...
  CONSTRAINT customer_addresses_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES public.customers(id)
    ...
    'discounts': """CREATE TABLE public.discounts (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  ...
  CONSTRAINT discounts_specific_customer_id_fkey FOREIGN KEY (specific_customer_id) REFERENCES public.customers(id)
    ...
    'customer_discount_usage': """CREATE TABLE public.customer_discount_usage (
  customer_id uuid NOT NULL,
  ...
  CONSTRAINT customer_discount_usage_discount_id_fkey FOREIGN KEY (discount_id) REFERENCES public.discounts(id)
    ...
    'customer_favorites': """CREATE TABLE public.customer_favorites (
  customer_id uuid NOT NULL,
  product_id uuid NOT NULL,
  created_at timestamp with time zone DEFAULT now(),
  ...
  CONSTRAINT customer_favorites_product_id_fkey FOREIGN KEY (product_id) REFERENCES public.products(id)
    ...
    'customer_reward_claims': """CREATE TABLE public.customer_reward_claims (
  customer_id uuid NOT NULL,
  ...
  CONSTRAINT orders_discount_code_fkey FOREIGN KEY (discount_code) REFERENCES public.discounts(code)
    ...
    'order_items': """CREATE TABLE public.order_items (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  ...
  CONSTRAINT order_items_product_id_fkey FOREIGN KEY (product_id) REFERENCES public.products(id)
    ...
    'product_reviews': """CREATE TABLE public.product_reviews (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  product_id uuid NOT NULL,
  customer_id uuid NOT NULL,
  ...
  CONSTRAINT product_reviews_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES public.customers(id)
    ...
    'push_subscriptions': """CREATE TABLE public.push_subscriptions (
  ...
  CONSTRAINT push_subscriptions_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES public.customers(id)
    ...
    'special_prices': """CREATE TABLE public.special_prices (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  product_id uuid,
  category_id uuid,
  ...
  CONSTRAINT special_prices_category_id_fkey FOREIGN KEY (category_id) REFERENCES public.categories(id)
    ...
    'terms_and_conditions': """CREATE TABLE public.terms_and_conditions (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  ...
  CONSTRAINT terms_and_conditions_pkey PRIMARY KEY (id)
    ...
    'customer_terms_acceptances': """CREATE TABLE public.customer_terms_acceptances (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  customer_id uuid NOT NULL,
  ...
  CONSTRAINT customer_terms_acceptances_terms_version_id_fkey FOREIGN KEY (terms_version_id) REFERENCES public.terms_and_conditions(id)
    ...
    'admins': """CREATE TABLE public.admins (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  name character varying NOT NULL,
  ...
  CONSTRAINT admins_pkey PRIMARY KEY (id)
    ...
    'business_exceptions': """CREATE TABLE public.business_exceptions (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  ...
  CONSTRAINT business_hours_pkey PRIMARY KEY (id)
    ...
    'settings': """CREATE TABLE public.settings (
  key text NOT NULL,
  value jsonb,
  description text,
...
order = [
    'admin_role', 'discount_type', 'order_status',
    'referral_levels', 'rewards', 'categories', 'products', 'product_images',
    'ingredients', 'ingredient_purchase_units', 'ingredient_purchases', 'product_recipes',
    'customers', 'customer_addresses', 'discounts', 'customer_discount_usage',
    'customer_favorites', 'customer_reward_claims', 'orders', 'order_items',
    'product_reviews', 'push_subscriptions', 'special_prices', 'terms_and_conditions',
    'customer_terms_acceptances', 'admins', 'business_exceptions', 'business_hours', 'settings'
]

with open('scratch/baseline_candidate.sql', 'w', encoding='utf-8') as f:
    f.write('-- BASELINE CANDIDATE SQL\n\n')
    for k in order:
        f.write(tables[k] + '\n\n')
